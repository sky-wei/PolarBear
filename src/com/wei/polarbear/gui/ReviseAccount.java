...
public class ReviseAccount extends JDialog {
	...
	private OrdinaryUser originalUser;
	private OrdinaryUser ordinaryUser;
	
	public ReviseAccount(JFrame frame, OrdinaryUser originalUser) {
	...
	private JPanel newContentPanel() {
		...
		contentPanel.setBorder(BorderFactory.createTitledBorder(
				BorderFactory.createEtchedBorder(), "用户-修改"));
	...
	private void setReviseContent() {
		...
		userName.setText(originalUser.getName());
		userPassword.setText(originalUser.getPassword());
		userDescr.setText(originalUser.getDescr());
	}
	...
	private OrdinaryUser getReviseUser() {
		...
		OrdinaryUser reviseUser = originalUser.clone();
		reviseUser.setName(userName);
	...
	class ActionEventHandle implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if ("OK".equals(action)) {
				OrdinaryUser ordinaryUser = getReviseUser();
				if (ordinaryUser != null) {
					ReviseAccount.this.cancel = false;
					ReviseAccount.this.ordinaryUser = ordinaryUser;
					ReviseAccount.this.dispose();
				}
